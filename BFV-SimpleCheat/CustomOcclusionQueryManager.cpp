...
t_fb__WorldOcclusionQueryRenderModule__drawBatchQuery           fb__WorldOcclusionQueryRenderModule__drawBatchQuery =           (t_fb__WorldOcclusionQueryRenderModule__drawBatchQuery)         0x14196BE20; //4C 8B CD 4C 8B C7 48 8B D6 49 8B CE E8 ?? ?? ?? ?? EB 10
t_fb__WorldOcclusionQueryRenderModule__retrieveBatchQueryData   fb__WorldOcclusionQueryRenderModule__retrieveBatchQueryData =   (t_fb__WorldOcclusionQueryRenderModule__retrieveBatchQueryData) 0x1419885C0; //pattern from above minus two
t_fb__WorldOcclusionQueryRenderModule__processBatchQueries      fb__WorldOcclusionQueryRenderModule__processBatchQueries =      (t_fb__WorldOcclusionQueryRenderModule__processBatchQueries)    0x141987520; //00 00 C6 44 ?? ?? ?? 41 B1 01 49 8B D4 E8
